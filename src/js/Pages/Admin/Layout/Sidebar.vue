  ...
  <aside class="md:flex flex-col h-full w-80 bg-white hidden">
      ...
      <div class="flex-1">
        <ul class="pt-2 space-y-1 text-sm mb-2">
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/dashboard">
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/students">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/users">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M17 20c0-1.657-2.239-3-5-3s-5 1.343-5 3m14-3c0-1.23-1.234-2.287-3-2.75M3 17c0-1.23 1.234-2.287 3-2.75m12-4.014a3 3 0 1 0-4-4.472m-8 4.472a3 3 0 0 1 4-4.472M12 14a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z">
                </path>
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/payment-logs">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/support">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/team/users">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M21 20c0-1.742-1.67-3.223-4-3.773M15 20c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-7a4 4 0 0 0 0-8m-6 8a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z">
                </path>
              </svg>
              <span>Team</span>
            </a>
        ...
        <ul class="pb-4 space-y-1 text-sm mt-2">
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/team/roles">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M21 20c0-1.742-1.67-3.223-4-3.773M15 20c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-7a4 4 0 0 0 0-8m-6 8a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z">
                </path>
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/plans">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 11v4.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h11.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104V11M3 11V9m0 2h18M3 9v-.8c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105V9M3 9h18M7 15h4m10-4V9">
                </path>
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/faqs">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="currentColor"
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/testimonials">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
            <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md" href="/admin/settings/general">
    ...
    <a class="border-2 border-primary text-sm rounded-[5px] mb-1 m-3 py-2 px-4 flex items-center justify-between cursor-pointer" href="/admin/addons">
      ...
      <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M9 17.898c0 1.074 1.265 1.648 2.073.941l6.31-5.522a1.75 1.75 0 0 0 0-2.634l-6.31-5.522C10.265 4.454 9 5.028 9 6.102z">
          </path>
        </svg>
      </span>
    </a>
    ...
    <div class="flex items-center m-3 p-2 rounded-[5px] h-20 py-1 md:py-1 mt-2 space-x-4 justify-between bg-slate-50">
      ...
      <button @click="logout" class="hover:bg-[#F6F7F9] hover:rounded-full w-[fit-content] p-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
...
export default {
  ...
  methods: {
    ...
    logout() {
      axios.post(`${import.meta.env.VITE_API}/api/logout`)
        .then(() => {
